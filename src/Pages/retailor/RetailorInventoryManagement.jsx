...
// import { RetailorLayout } from './RetailorLayout';

// export const RetailorInventorymanagement = () => {
...
//       const response = await axios.get(`${API_BASE_URL}/api/retailer/get-products`, {
...
//     try {
//       const response = await axios.get(`${API_BASE_URL}/api/retailer/get-category`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//         }
//         await axios.put(`${API_BASE_URL}/api/retailer/update-products/${isEdit.productId}`, data, {
//           headers: {
...
//           throw new Error('At least one product image is required');
//         }
//         await axios.post(`${API_BASE_URL}/api/retailer/create-product`, data, {
//           headers: {
//             Authorization: `Bearer ${token}`,
//             'Content-Type': 'multipart/form-data',
//           },
...
//       try {
//         await axios.delete(`${API_BASE_URL}/api/retailer/delete-product/${id}`, {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
export const RetailorInventorymanagement = () => {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`${API_BASE_URL}/api/retailer/delete-product/${showDeleteModal.productId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      setSuccess('Product deleted successfully!');
      fetchProducts();
