...
// };
// import "./WholesalerInventory.scss";

// export const WholesalerInventory = () => {
//   const [rowData, setRowData] = useState([
//     {
//       Product: "Cobalt PET Bottle with Lotion Pump",
//       ID: "#05843",
//       Stock: "45",
//       Buy: "$2.15",
//       Sell: "$3.10",
//       Category: "Lotion",
//       LastStockDate: "28 March 2025",
//       MinimumQuantity: 500,
//       Discount: "50%",
//       Action: "View",
//     },
...
//     { field: "Category" },
//     { field: "LastStockDate" },
//     { field: "MinimumQuantity" },  // **** this is only for wholesale, retailer will not have this field *****
//     { field: "Discount" },
//     { field: "Action" },
//   ]);
...
//       const response = await axios.get(`${API_BASE_URL}/api/wholesaler/get-products`, {
...
//     try {
//       const response = await axios.get(`${API_BASE_URL}/api/wholesaler/get-category`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//         }
//         await axios.put(`${API_BASE_URL}/api/wholesaler/update-products/${isEdit.productId}`, data, {
//           headers: {
...
//           throw new Error('At least one product image is required');
//         }
//         await axios.post(`${API_BASE_URL}/api/wholesaler/create-product`, data, {
//           headers: {
//             Authorization: `Bearer ${token}`,
//             'Content-Type': 'multipart/form-data',
//           },
...
//       try {
//         await axios.delete(`${API_BASE_URL}/api/wholesaler/delete-product/${id}`, {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
export const WholesalerInventory = () => {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`${API_BASE_URL}/api/wholesaler/delete-product/${showDeleteModal.productId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      setSuccess('Product deleted successfully!');
      fetchProducts();
