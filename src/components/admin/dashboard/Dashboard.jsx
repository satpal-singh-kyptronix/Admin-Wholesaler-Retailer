...
const dateFormatter = (params) => {
  return new Date("2025-02-30").toLocaleDateString("en-us", {
    weekday: "long",
    year: "numeric",
    month: "short",
    day: "numeric",
  ...
  return (
    <div className="dashboard__mainWrapper">
      ...
      <div className="totalRevenue__mainWrapper">
        ...
        <div className="totalRevenue__graphMainWrapper">
          <h4 className="totalRevenue__graphHeading">Revenue Graph</h4>

          <div className="totalRevenue__lineGraphWrapper">
            <Linechart aspectRatio={5} />
          </div>
        </div>
      </div>
      {/* total revenue graph and card wraper */}
